...
namespace ncnn {
class Gemm_final : virtual public Gemm, virtual public Gemm_arm
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Gemm::create_pipeline(opt); if (ret) return ret; }
        { int ret = Gemm_arm::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Gemm_arm::destroy_pipeline(opt); if (ret) return ret; }
...
namespace ncnn {
class DeformableConv2D_final : virtual public DeformableConv2D
{
public:
    virtual int create_pipeline(const Option& opt) {
